...
class Product {
  ...
  addEventListeners() {
    listen('submit', '.productInList form , .product form', event => {
      //all web browser wants to reload the page on form submit for historical reasons
      //we dont want that.so we ask the broswer not to do the defualt action 
      event.preventDefault();
      //get the form element and 
